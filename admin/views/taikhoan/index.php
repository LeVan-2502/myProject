          ...
          <div class="card">
            <div class="card-header">
              <div class="row">
                ...
                <div class="col-2">
                  <a href="<?= BASE_URL_ADMIN ?>?act=form-them-quantrivien" class="btn btn-success ">Thêm mới <?= $chucvu?></a>
                </div>
              </div>
                  ...
                  <?php foreach ($listTaiKhoan as $key => $tk) : ?>
                    <tr>
                      ...
                      <td class="align-middle">
                        <a href="<?= BASE_URL_ADMIN . '?act=form-sua-quantrivien&id_tai_khoan=' . $tk['id'] ?>" class="btn btn-warning">Sửa</a>
                        <a class="btn btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa không?')" href="<?= BASE_URL_ADMIN . '?act=xoa-quantrivien&id_tai_khoan=' . $tk['id'] ?>">Xóa</a>
                      </td>
                    </tr>
                  <?php endforeach ?>
                </tbody>
