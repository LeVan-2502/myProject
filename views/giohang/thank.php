                                ...
                                <div class="shop-cart">
                                    <div class="row">
                                        <div class="thank-you-card">
                                            ...
                                            <div class="btn-order">
                                                <a href="<?=BASE_URL .'?act=checkout-success&role=chitiet'?>" class="btn btn-secondary text-white">Chi tiết đơn hàng</a>
                                                <a href="<?=BASE_URL .'?act=checkout-success&role=muahang'?>" class="btn btn-primary text-white">Tiếp tục mua hàng</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
