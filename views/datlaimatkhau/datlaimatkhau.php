													...
													<div class="card-body">
                                                        ...
                                                        <h2>Đặt lại mật khẩu của bạn</h2>
															<div class="form-group">
																<input placeholder="Nhập mật khẩu mới" type="text" class="form-control" name="mat_khau_reset" id="mat_khau" required>
															</div>
															<div class="form-group">			
																<input  placeholder="Xác nhận mật khẩu mới" type="text" class="form-control" name="mat_khau_xacnhan" id="email" required>
															</div>
																																					
															<?php if (isset($_SESSION['errors']['mat_khau'])) { ?>
																<div class="text-danger"><?= $_SESSION['errors']['mat_khau'] ?></div>
															<?php } ?>				
